...
public class OptiFineRayTracing {

    private static String version;

    public static void init(String args) {
        OptiFineRayTracing.version = args;
        start();
    }

    private static void start() {
        startSocket();
        log(INFO, "Enable touchinjector for optifine/liteloader " + version);
    }
    ...
    private static void rayTrace() {
        ...
        Thread thread = new Thread("OptiFine Raytrace thread") {
            public void run() {
    ...
    public static String getRaytraceResultType17() {
        try {
            Class<?> minecraftClass = Class.forName("bao", true, Launch.classLoader);
    ...
    public static String getRaytraceResultType18() {
        try {
            Class<?> minecraftClass = Class.forName("ave", true, Launch.classLoader);
    ...
    public static String getRaytraceResultType19() {
        try {
            Class<?> minecraftClass = Class.forName("bcd", true, Launch.classLoader);
    ...
    public static String getRaytraceResultType110() {
        try {
            Class<?> minecraftClass = Class.forName("bcx", true, Launch.classLoader);
            Method method = minecraftClass.getDeclaredMethod("z");
            Object minecraft = method.invoke(null);
            Field targetField = minecraftClass.getDeclaredField("t");
            targetField.setAccessible(true);
    ...
    public static String getRaytraceResultType111() {
        try {
            Class<?> minecraftClass = Class.forName("bes", true, Launch.classLoader);
            Method method = minecraftClass.getDeclaredMethod("z");
            Object minecraft = method.invoke(null);
            Field targetField = minecraftClass.getDeclaredField("t");
            targetField.setAccessible(true);
    ...
    public static String getRaytraceResultType112() {
        try {
            Class<?> minecraftClass = Class.forName("bib", true, Launch.classLoader);
            Method method = minecraftClass.getDeclaredMethod("z");
            Object minecraft = method.invoke(null);
            Field targetField = minecraftClass.getDeclaredField("s");
            targetField.setAccessible(true);
    ...
    public static String getRaytraceResultType113() {
        try {
            Class<?> minecraftClass = Class.forName("cft", true, Launch.classLoader);
    ...
    public static String getRaytraceResultType114() {
        try {
            Class<?> minecraftClass = Class.forName("cyc", true, Launch.classLoader);
    ...
    public static String getRaytraceResultType115() {
        try {
            Class<?> minecraftClass = Class.forName("dbn", true, Launch.classLoader);
    ...
    public static String getRaytraceResultType116() {
        try {
            Class<?> minecraftClass = Class.forName("djz", true, Launch.classLoader);
    ...
    public static String getRaytraceResultType117() {
        try {
            Class<?> minecraftClass = Class.forName("dvp", true, Launch.classLoader);
            Method method = minecraftClass.getDeclaredMethod("C");
            Object minecraft = method.invoke(null);
            Field targetField = minecraftClass.getDeclaredField("v");
            targetField.setAccessible(true);
    ...
    public static String getRaytraceResultType118() {
        try {
            Class<?> minecraftClass = Class.forName("dyr", true, Launch.classLoader);
    ...
    public static String getRaytraceResultType119() {
        try {
            Class<?> minecraftClass = Class.forName("eev", true, Launch.classLoader);
